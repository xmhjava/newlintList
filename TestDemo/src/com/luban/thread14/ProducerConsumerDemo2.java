...
class Producerdemo2 implements Runnable
{
	private Resourcedemo2 r;
	Producerdemo2(Resourcedemo2 r)
	{
		this.r = r;
	}
	public void run()
...
class Consumerdemo2 implements Runnable
{
	private Resourcedemo2 r;
	Consumerdemo2(Resourcedemo2 r)
	{
		this.r = r;
	}
	public void run()
...
public class ProducerConsumerDemo2 {
	...
	{
		Resourcedemo2 r = new Resourcedemo2();
		Producerdemo2 pro = new Producerdemo2(r);
		Consumerdemo2 con = new Consumerdemo2(r);
